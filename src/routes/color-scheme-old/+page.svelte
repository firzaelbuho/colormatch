<script lang="ts">
	...
	import InputCard from '$lib/modules/color-scheme/components/InputCard.svelte';
	import ColorBarCard from '$lib/modules/color-scheme/components/ColorBarCard.svelte';
	import PaletteList from '$lib/modules/color-scheme/components/PaletteList.svelte';
	import MockupPreview from '$lib/modules/color-scheme/components/MockupPreview.svelte';
